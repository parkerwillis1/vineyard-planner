          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                ...
                className="group inline-flex items-center gap-2 rounded-xl bg-white px-8 py-4 text-base font-bold text-teal-700 shadow-xl hover:bg-gray-50 transition-all hover:scale-105"
              >
      ...
      <section className="bg-gradient-to-br from-teal-50 to-vine-green-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Purpose-built for vineyard financial planning
            </p>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <th className="py-4 px-6 text-center text-sm font-bold text-teal-700">
                      Trellis Planner
                    </th>
  ...
  return (
    <div className={`grid grid-cols-1 gap-12 lg:grid-cols-2 items-center ${reverse ? 'lg:flex-row-reverse' : ''}`}>
      <div className={reverse ? 'lg:order-2' : ''}>
        ...
        <div className="inline-block rounded-full px-3 py-1 text-xs font-semibold mb-4 ml-3 bg-teal-100 text-teal-700">
          {eyebrow}
        </div>
        ...
        <ul className="space-y-3 mb-8">
          {features.map((feature, idx) => (
            <li key={idx} className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 mt-0.5 flex-shrink-0 text-teal-500" />
        ...
        <Link
          to={ctaLink}
          className="inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-bold text-white shadow-md hover:shadow-lg transition-all hover:scale-105 bg-gradient-to-r from-teal-600 to-teal-700"
        >
          {ctaText}
    ...
    <div className="rounded-2xl bg-gradient-to-br from-gray-50 to-white p-8 shadow-xl border-2 border-gray-200">
      <div className="space-y-4">
        <div className="flex items-center justify-between pb-4 border-b border-gray-200">
          <span className="text-sm font-semibold text-gray-900">10-Year Revenue Projection</span>
  ...
  return (
    <div className="rounded-2xl bg-white p-8 shadow-xl border-2 border-gray-200">
      <div className="space-y-4">
        ...
        <div className="relative bg-white rounded-lg overflow-hidden border-2 border-teal-200 shadow-lg">
          <img
            src="/Field_Map_1.png"
...
function LoanPlanningDemo() {
  return (
    <div className="rounded-2xl bg-gradient-to-br from-gray-50 to-white p-8 shadow-xl border-2 border-gray-200">
      <div className="space-y-4">
        <div className="flex items-center justify-between pb-4 border-b border-gray-200">
          <span className="text-sm font-semibold text-gray-900">Financing Summary</span>
